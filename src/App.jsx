  ...
  return (
    <>
      <div className='w-full h-screen flex items-center justify-center bg-zinc-100' id='outer-div'>
        <div className="mx-auto w-full md:w-[50%] h-[60svh] md:h-[42svh] lg:h-[60svh] rounded-lg px-6 border border-zinc-200 bg-zinc-50 flex items-center justify-center flex-col gap-4" id='inner-div'>
